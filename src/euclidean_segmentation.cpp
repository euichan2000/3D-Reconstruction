...
int main(int argc, char **argv)
{
  ...
  *cloud = *data[0].cloud;
  ...
  std::stringstream clusterFileName;
  clusterFileName << "../pcd/segmented_pcd/fenda/segmented_fenda_"
                  << ".pcd";
  pcl::io::savePCDFile(clusterFileName.str(), *(largest_cluster), false);
  ...
  //   std::stringstream clusterFileName;
  //   clusterFileName << "../pcd/segmented_pcd/fenda/segmented_fenda_" << j << ".pcd";
  //   pcl::io::savePCDFile(clusterFileName.str(), *(cloud_cluster), false);
